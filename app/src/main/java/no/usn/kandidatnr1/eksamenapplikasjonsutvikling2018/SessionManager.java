...
/**
 * Dette er klassen som behandler session ved å lagre informasjon
 * i shardedpreferences.Dette for å kunne ta vare på informasjon
 * om bruker som er logget inn. Koden er hentet fra:
...
public class SessionManager {
    ...
    private static final String PREF_NAME = "SamkjøringPref";
